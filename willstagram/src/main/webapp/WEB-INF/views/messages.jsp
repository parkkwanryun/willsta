...
div.messages-list>ul>li:hover {
		...
		<header>
			<div class="container">
				<div class="header-data">
					...
					<nav>
						<ul>
							<li><a href="index.html" title=""> <span><img
										src="images/icon1.png" alt=""></span> Home
							</a></li>
							...
							<li><a href="jobs.html" title=""> <span><img
										src="images/icon5.png" alt=""></span> Jobs
							</a></li>
							<li><a href="#" title="" class="not-box-openm"> <span><img
										src="images/icon6.png" alt=""></span> Messages
							</a>
					...
					<div class="user-account">
						<div class="user-info">
							<img src="" alt=""> <a href="#" title="">John</a> <i
	...
	<script type="text/javascript">
		...
		$(function() {
			$(document).find('.messages-list > ul ').on('click', function(e) {
