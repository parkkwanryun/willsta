...
<body>
	...
	<div class="wrapper">
								...
								<div class="main-left-sidebar no-margin">
									<div class="user-data full-width">
										...
										<ul class="user-fw-status">
											...
											<li><a href="my-profile.html" title="">View Profile</a>
											</li>
										</ul>
									</div>
									<!--user-data end-->
									...
									<div class="posts-section">
										...
										<c:forEach var="post" items="${postList}">
											...
											<div class="post-bar" post_no="${post.pNo}">
													...
													<div class="ed-opts">
														...
														<c:if test="${post.mId!=sessionScope.loginId}">
															<ul class="ed-options">
																...
																<li><a class="hiddenPost" href="#" title=""> <c:if
																			test="${post.status=='A'}">Hide</c:if> <c:if
																			test="${post.status=='H'}">Show</c:if>
																</a></li>
															</ul>
														</c:if>
													</div>
													...
													<c:if test="${fn:startsWith(post.fileName, 'img')}">
														<div class="image">
															<img class="center-block" style="margin: 10px 0px;"
																src="contents/post_contents/${post.fileName}"
																alt="여기에이미지들어옴" width="500" height="300">
														</div>
													</c:if>
												...
												<!-- comment-section -->
												<div class="comment-section"><div class="comment-sec"></div></div>
												<!--comment-section end-->
												<!-- post-comment -->
		...
		<div class="post-popup post_deatil"></div>


		<div class="chatbox-list">
			<div class="chatbox">
				<div class="chat-mg">
					<a href="#" title=""><img src="images/resources/usr-img1.png"
						alt=""></a> <span>2</span>
				</div>
			...
			<div class="chatbox">
				<div class="chat-mg">
					<a href="#" title=""><img src="images/resources/usr-img2.png"
						alt=""></a>
				</div>
				<div class="conversation-box">
					<div class="con-title mg-3">
			...
			<div class="chatbox">
				<div class="chat-mg bx">
					<a href="#" title=""><img src="images/chat.png" alt=""></a> <span>2</span>
				</div>
				<div class="conversation-box">
					<div class="con-title">
						<h3>Messages</h3>
					...
					<div class="chat-list">
						<div class="conv-list active">
							<div class="usrr-pic">
								<img src="images/resources/usy1.png" alt=""> <span
									class="active-status activee"></span>
							</div>
							<div class="usy-info">
								<h3>John Doe</h3>
								<span>Lorem ipsum dolor <img src="images/smley.png"
									alt=""></span>
							</div>
							<div class="ct-time">
								<span>1:55 PM</span>
