...
<body>
		<header>
			<div class="container">
				<div class="header-data">
					<div class="logo">
						<a href="*.jsp" title=""><img src="images/logo.png" alt=""></a>
					</div><!--logo end-->
					...
					<nav>
						<ul>
							...
							<li>
								...
								<ul>
									<li><a href="*.jsp" title="">Companies</a></li>
									<li><a href="*.jsp" title="">Company Profile</a></li>
								</ul>
							</li>
							<li>
								<a href="*.jsp" title="">
							...
							<li>
								...
								<ul>
									<li><a href="*.jsp" title="">User Profile</a></li>
									<li><a href="*.jsp" title="">my-profile-feed</a></li>
								</ul>
							</li>
							<li>
								<a href="*.jsp" title="">
									...
									<div class="nott-list">
										<div class="notfication-details">
							  				...
							  				<div class="notification-info">
							  					<h3><a href="*.jsp" title="">Jassica William</a> </h3>
						  				...
						  				<div class="view-all-nots">
						  					<a href="*.jsp" title="">View All Messsages</a>
						  				</div>
									</div><!--nott-list end-->
					...
					<div class="user-account">
						...
						<div class="user-account-settingss">
							...
							<h3>Setting</h3>
							<ul class="us-links">
								<li><a href="*.jsp" title="">Account Setting</a></li>
								<li><a href="#" title="">Privacy</a></li>
								<li><a href="#" title="">Faqs</a></li>
								<li><a href="#" title="">Terms & Conditions</a></li>
							</ul>
							<h3 class="tc"><a href="*.jsp" title="">Logout</a></h3>
		...
		<footer>
			<div class="footy-sec mn no-margin">
				<div class="container">
					<ul>
						<li><a href="*.jsp" title="">Help Center</a></li>
						<li><a href="*.jsp" title="">About</a></li>
						<li><a href="#" title="">Privacy Policy</a></li>
						<li><a href="#" title="">Community Guidelines</a></li>
						<li><a href="#" title="">Cookies Policy</a></li>
						<li><a href="#" title="">Career</a></li>
						<li><a href="*.jsp" title="">Forum</a></li>
